...
public class CustomerRepository : ICustomerRepository
{
    ...
    public CustomerRepository(NorthwindContext injectedContext)
    {
        ...
        // pre-load customers from db as a normal Dictonary w CustomerId as the key,
        // then convert to a thread-safe Concurrent Dictionary
    ...
    public async Task<Customer?> CreateAsync(Customer c)
    {
        ...
        if (affected == 1)
        {
            ...
            //if the customer is new, add it to cache else call UpdateCashe method
